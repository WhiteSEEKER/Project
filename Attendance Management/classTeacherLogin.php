...
<head>
    ...
    <title>Letran Student Attendance System</title>
    ...
    <div class="container-login">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card shadow-sm my-5" style="background-color: blue">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <img src="img/logo/Letran.png" style="width:100px;height:100px">
                                        <br><br>
