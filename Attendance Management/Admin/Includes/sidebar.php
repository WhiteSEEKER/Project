 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
     <a class="sidebar-brand d-flex align-items-center bg-gradient-primary  justify-content-center" href="index.php">
         <div class="sidebar-brand-icon">
             <img src="img/logo/Letran.png">
         </div>
         <div class="sidebar-brand-text mx-3">Letran Student Attendance System</div>
     </a>
...
.bg-gradient-primary {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(10%, #00308f), to(#303f9f));
  background-image: linear-gradient(180deg, #00308f 10%, #23297a 100%);
